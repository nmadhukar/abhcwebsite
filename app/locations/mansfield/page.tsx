...
export const metadata: Metadata = {
  title: "Mansfield Location - Autumn Behavioral Health Center",
  description:
    "Outpatient treatment, mental health services, addiction treatment, and case management at our Mansfield location. Comprehensive behavioral health care.",
  keywords: ["Mansfield", "outpatient treatment", "mental health", "addiction treatment", "case management"],
}

const carouselImages = [
  {
    src: "/mansfield-facility-exterior.png",
    alt: "Mansfield facility exterior",
    caption: "Modern Mansfield Facility - Main Entrance",
  },
  {
    src: "/mansfield-facility-lobby.png",
    alt: "Mansfield facility lobby and reception area",
    caption: "Welcoming Lobby and Reception Area",
  },
  {
    src: "/mansfield-facility-therapy-room.png",
    alt: "Mansfield facility private therapy room",
    caption: "Private Therapy Rooms for Individual Sessions",
  },
  {
    src: "/mansfield-facility-group-room.png",
    alt: "Mansfield facility group therapy space",
    caption: "Comfortable Group Therapy Spaces",
  },
  {
    src: "/mansfield-facility-parking.png",
    alt: "Mansfield facility parking area",
  ...
  return (
    <main className="min-h-screen">
      ...
      <section className="bg-gradient-to-r from-blue-900 to-blue-800 text-white py-20">
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto text-center">
            <h1 className="text-4xl md:text-5xl font-bold mb-6">Autumn Behavioral Health - Mansfield</h1>
            <p className="text-xl mb-8 text-blue-100">
              Comprehensive outpatient treatment, mental health services, and addiction treatment in Mansfield
            </p>
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              ...
              >
                <a
                  href="https://maps.google.com/?q=650+Park+Avenue+W+Mansfield+OH+44906"
                  target="_blank"
              ...
              <div className="space-y-6">
                <div className="flex items-start">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600">650 Park Avenue W</p>
                    <p className="text-gray-600">Mansfield, OH 44906</p>
                  </div>
                </div>
                ...
                <Card className="border-l-4 border-l-brand-green">
                  <CardContent className="p-6">
                    ...
                    <p className="text-gray-600">
                      Flexible outpatient programs that allow you to receive treatment while maintaining your daily
                      responsibilities.
                    </p>
                  </CardContent>
                </Card>
      ...
      <section className="py-16 bg-gray-50">
        <div className="container mx-auto px-4">
          <h2 className="text-3xl font-bold text-center text-gray-900 mb-12">Why Choose Mansfield?</h2>
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
            <div className="text-center">
              ...
              <p className="text-gray-600">
                Licensed professionals with extensive experience in behavioral health treatment.
              </p>
            </div>
            ...
            <div className="text-center">
              ...
              <p className="text-gray-600">
                Individualized treatment plans tailored to meet your specific needs and goals.
              </p>
            </div>
            ...
            <div className="text-center">
              ...
              <p className="text-gray-600">Secure, comfortable facility designed to promote healing and recovery.</p>
            </div>
      ...
      <section className="py-16 bg-gradient-to-r from-blue-900 to-blue-800 text-white">
        <div className="container mx-auto px-4 text-center">
          ...
          <p className="text-xl mb-8 text-blue-100 max-w-2xl mx-auto">
            Take the first step toward healing and recovery. Our Mansfield team is here to support you every step of the
            way.
          </p>
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <Button size="lg" className="bg-brand-green hover:bg-green-600">
